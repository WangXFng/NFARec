...
#
training_set = open('../../../Yelp2023/Yelp2023_train.txt', 'r').readlines()
tuning_set = open('../../../Yelp2023/Yelp2023_tune.txt', 'r').readlines()
# eachline = f.readline()
...
test_set = open('../../../Yelp2023/Yelp2023_test.txt', 'r').readlines()
user_test = {}
