...
#
training_set = open('../../../Amazon-book/Amazon-book_train.txt', 'r').readlines()
tuning_set = open('../../../Amazon-book/Amazon-book_tune.txt', 'r').readlines()
# eachline = f.readline()
...
test_set = open('../../../Amazon-book/Amazon-book_test.txt', 'r').readlines()
user_test = {}
