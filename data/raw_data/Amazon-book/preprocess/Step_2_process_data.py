...
with open('ratings_Books.csv', encoding='utf-8') as f:
    ...
    while line:
        ...
        # print(user_id, (user_id in new_user_map))

        # if (user_id in new_user_map):
        ...
        try:
            ...
            if int_user_id not in user_traj:
                user_traj[int_user_id] = [(int_item_id, int(float(rating)), int(float(timestamp)))]
            else:
...
train = open('../../../Amazon-book/Amazon-book_train.txt', 'w')
tune = open('../../../Amazon-book/Amazon-book_tune.txt', 'w')
test = open('../../../Amazon-book/Amazon-book_test.txt', 'w')
