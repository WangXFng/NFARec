...
#
training_set = open('../../Beauty/Beauty_train.txt', 'r').readlines()
tuning_set = open('../../Beauty/Beauty_tune.txt', 'r').readlines()
# eachline = f.readline()
...
test_set = open('../../Beauty/Beauty_test.txt', 'r').readlines()
user_test = {}
