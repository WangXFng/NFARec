...
# user_idx_ndcg = np.load('user_idx_ndcg.npy')
#
...
# new_user_map = pickle.load('new_user_map.pkl')
...
#
#
# data_output = open('user_reviews.pkl', 'wb')
# pickle.dump({'user_reviews': user_reviews}, data_output)
# data_output.close()
# print('File: ', 'user_reviews.pkl', 'saved!')





with open('../user_reviews.pkl', 'rb') as f:
...
for u in user_reviews:
    ...
    if u == 'U_cXBfhpmvmkTbF3SaVcZA':
        ...
        # print(user_reviews[u][int(len(user_reviews[u]) * 0.8)-1: int(len(user_reviews[u]) * 0.8)+2])
        #
        # print(user_reviews[u][273])
        #
        # print(user_reviews[u][284])
